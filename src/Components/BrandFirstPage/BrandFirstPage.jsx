...
import Notavailable from "../NotAvailble/Notavailable";
...
const BrandFirstPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-1">
      <AddSlider slidesShow={loader.payload[0]?.brand} />
      <div className="grid grid-cols-1 my-16 md:grid-cols-4 md:gap-2 ">
