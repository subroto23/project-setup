...
const Footer = () => {
  return (
    <div className="px-4 pt-16 bg-green-500 text-white mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 max-w-6xl mx-auto mb-8 sm:grid-cols-2 lg:grid-cols-4">
